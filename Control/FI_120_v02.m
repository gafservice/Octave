...
ylabel('Magnitud');
xlim([fc - 1e4, fc + 1e4]); % Mostrar un rango más amplio alrededor de 110 MHz
...
xlabel('Frecuencia (Hz)');
ylabel('Magnitud');
xlim([f_lo - 1e4, f_lo + 1e4]); % Mostrar un rango más amplio alrededor de 120.7 MHz
...
% Filtrar la señal IF para extraer la componente de 13125 Hz (subportadora)
...
% Graficar la señal demodulada en el dominio del tiempo y frecuencia
figure;
